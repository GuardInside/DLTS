...
/* Идентификаторы */
#define REFRESH_INFO                100 //Сообщение dlg_arrhenius для обновления E и S
...
extern bool recalculate_dlts; //Пересчитывать ли DLTS график при перерисовки окна
...
extern HANDLE                      hThread_DAQ;//Описатель потока DAQ
...
extern HWND                        hGraph_Arrhenius;//Описатель окна графика Аррениуса
