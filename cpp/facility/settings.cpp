...
void write_settings()
{
    ...
    iniFile.WriteDoubleFix("Generator", "step_voltage", Generator.step_amp, VOLTAGE_PRECISION);
    iniFile.WriteDoubleFix("Generator", "begin_amplitude", Generator.begin_amp, VOLTAGE_PRECISION);
    iniFile.WriteDoubleFix("Generator", "end_amplitude", Generator.end_amp, VOLTAGE_PRECISION);
    ...
    iniFile.WriteInt("General", "mode", index_mode.load());
...
void read_settings()
{
    ...
    iniFile.ReadDouble("Generator", "step_voltage", &Generator.step_amp);
    iniFile.ReadDouble("Generator", "begin_amplitude", &Generator.begin_amp);
    iniFile.ReadDouble("Generator", "end_amplitude", &Generator.end_amp);
